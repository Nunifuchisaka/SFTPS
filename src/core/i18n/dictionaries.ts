...
export const dictionaries: Record<Locale, Dictionary> = {
  ja: {
    ...
    'browser.local': 'ローカル',
    'browser.localDropHint': 'ローカル（ここへリモートからドラッグでDL）',
    'browser.remoteDropHint': 'リモート（ここにOSからファイルをドロップでUL / ローカルからドラッグでUL）',
    'btn.connect': '接続',
    'btn.edit': '編集',
    'btn.delete': '削除',
    'btn.save': '保存',
  ...
  en: {
    ...
    'browser.local': 'Local',
    'browser.localDropHint': 'Local (drag items here from Remote to download)',
    'browser.remoteDropHint': 'Remote (drop OS files here, or drag from Local, to upload)',
    'btn.connect': 'Connect',
    'btn.edit': 'Edit',
    'btn.delete': 'Delete',
    'btn.save': 'Save',
