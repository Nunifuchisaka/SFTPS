...
export function registerTransferTools(server: McpServer, deps: TransferToolDeps): void {
  server.registerTool(
    'preview_upload',
    {
      ...
      inputSchema: { id: z.string(), localPath: z.string(), remotePath: z.string() },
    },
  ...
  server.registerTool(
    'preview_download',
    {
      ...
      inputSchema: { id: z.string(), remotePath: z.string(), savePath: z.string() },
    },
  ...
  server.registerTool(
    'preview_sync',
    {
      ...
      inputSchema: { id: z.string(), localDir: z.string(), remoteDir: z.string(), ...syncOptionsShape },
    },
  ...
  server.registerTool(
    'rename_remote',
    {
      ...
      inputSchema: { id: z.string(), from: z.string(), to: z.string() },
    },
    async ({ id, from, to }) => {
      await withHostKeyErrorEnrichment(deps.service, id, deps.rejections, () =>
  ...
  server.registerTool(
    'chmod_remote',
    {
      ...
      inputSchema: { id: z.string(), remotePath: z.string(), mode: z.number().int() },
    },
