...
function makeService(over: Partial<IpcService> = {}): { service: IpcService; calls: Recorded[] } {
  ...
  const base = {
    ...
    listProfileFolders: rec('listProfileFolders', []),
    saveProfileFolder: rec('saveProfileFolder', {}),
    deleteProfileFolder: rec('deleteProfileFolder'),
    reorderProfileFolders: rec('reorderProfileFolders', []),
    moveProfile: rec('moveProfile', []),
